        ...
        function drawRatingStar() {
            ...
            items.each(function(){
                ...
                for(var i = 0; i < configuration.ratingCount; i++){
                    ...
                    starImg.style.width = (configuration.width - 3 * configuration.border) + px;
                    starImg.style.height = (configuration.height - 3 * configuration.border) + px;
                    starImg.style.border = '5px solid black';
                ...
                $('.starDiv').on({
                    mouseover: function() {
                        //Check if maximum clicks has been made
                        if (_ratingRemainingClick($(bgDiv)) < 1) {
                            _removeRatingStarTitle($(starContainer));
                            return;
                        }
                        ...
                        //Maths
                        var hoverScore = $(this).parent().attr("id");
                        for (var i = 1; i <= hoverScore; ++i) {
                    ...
                    click: function(event) {
                        ...
                        if (_ratingRemainingClick($(bgDiv)) < 1) {
                            console.log(_ratingRemainingClick($(bgDiv)));
                            _removeRatingStarTitle($(starContainer));
                            return;
                        } else {
